...
$(shell wget https://github.com/EpicCash/epic/releases/download/v3.5.0/epic-3.5.0-startos-aarch64.tar.gz)
$(shell wget https://github.com/EpicCash/epic/releases/download/v3.5.0/epic-3.5.0-startos-aarch64-sha256sum.txt)
$(shell tar -zxf epic-3.5.0-startos-aarch64.tar.gz)
$(shell wget https://github.com/EpicCash/epic/releases/download/v3.5.0/epic-3.5.0-startos-x86_64.tar.gz)
$(shell wget https://github.com/EpicCash/epic/releases/download/v3.5.0/epic-3.5.0-startos-x86_64-sha256sum.txt)
$(shell tar -zxf epic-3.5.0-startos-x86_64.tar.gz)
valid1 := $(shell sha256sum -c epic-3.5.0-startos-x86_64-sha256sum.txt)
valid2 := $(shell sha256sum -c epic-3.5.0-startos-aarch64-sha256sum.txt)
